...
<section class="text-center py-5 text-white hero-text">
  <div class="container">
    ...
    <p class="lead mt-3 mb-4">
      Foundation libraries for .NET systems programming.<br>
      The long-term goal is building an experimental OS stack on a Linux kernel with C#/NativeAOT.
    </p>
    <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
      <a href="#projects" class="btn btn-primary btn-lg"><i class="bi bi-grid-3x3-gap"></i> Explore projects</a>
      <a href="https://github.com/XenoAtom/" class="btn btn-info btn-lg"><i class="bi bi-github"></i> GitHub organization</a>
    </div>
  </div>
</section>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          <ul class="mb-0">
            ...
            <li><a href="https://xenoatom.github.io/terminal/docs/terminal/">XenoAtom.Terminal docs section</a> · <a href="https://github.com/XenoAtom/XenoAtom.Terminal">GitHub</a></li>
            <li><a href="https://xenoatom.github.io/terminal/docs/ansi/">XenoAtom.Ansi docs section</a> · <a href="https://github.com/XenoAtom/XenoAtom.Ansi">GitHub</a></li>
            <li><a href="https://xenoatom.github.io/commandline/">XenoAtom.CommandLine docs</a> · <a href="https://github.com/XenoAtom/XenoAtom.CommandLine">GitHub</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          <ul class="mb-0">
            ...
            <li><a href="https://github.com/XenoAtom/XenoAtom.Collections">XenoAtom.Collections</a></li>
            <li><a href="https://github.com/XenoAtom/XenoAtom.Interop">XenoAtom.Interop</a></li>
            <li><a href="https://github.com/XenoAtom/XenoAtom.UnixTools">XenoAtom.UnixTools</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          <ul class="mb-0">
            ...
            <li><a href="https://github.com/XenoAtom/XenoAtom.ShaderCompiler">XenoAtom.ShaderCompiler</a></li>
          </ul>
        </div>
      </div>
    </div>
  </div>
  <p class="mt-4 mb-0">More repositories: <a href="https://github.com/orgs/XenoAtom/repositories">github.com/XenoAtom</a></p>
</section>
